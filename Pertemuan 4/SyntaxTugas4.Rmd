...
Akan dicoba membangkitkan proses MA, yaitu MA(2) dengan $\theta1 = 0.4$ dan $\theta2 = 0.6$ sebanyak 300 observasi dan $c=0$. Karena diperlukan satu nilai awal untuk $e_{t-1}$ dan $e_{t-2}$, masukkan nilai pertama white noise sebagai nilai awal tersebut.
...
n<-length(wn)
n
ar <- c(1:n) #bangkitkan data ar 1-300
for (i in 3:n) {ar[i]<-wn[i]+0.5*ar[i-1]+0.2*ar[i-2]} #looping dari 3-300
ar
```
...
$$
\rho_1=\frac{\phi_1}{1-\phi_2}=\frac{0.5}{1-0.2}=0.626
$$
...
$$
\rho_1=\frac{\phi_1^2}{1-\phi_2}+\phi_2=\frac{0.5^2}{1-0.2}+0.2=0.5125
$$
...
$$
\rho_1=\frac{\phi_1^3+\phi_1\phi_2}{1-\phi_2}+\phi_1\phi_2=\frac{0.5^2+(0.5)(0.2)}{1-0.2}+(0.5)(0.2)=0.38125
$$
...
Pembangkitan proses ARMA(2,2) secara manual
